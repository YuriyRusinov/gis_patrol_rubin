...
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (51, 10, null::integer, false, 'Проекции', 'SYSCATEGORY_51', null::varchar, true);
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (52, 8, 51, true, 'Справочник проекций', 'SYSCATEGORY_52', null::varchar, true);
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (171, 10, null::integer, false, 'Группы параметров (пользовательские)',  'SYSCATEGORY_171', null::varchar, true);
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (172, 8, 171, true,  'Справочник групп параметров', 'SYSCATEGORY_172', null::varchar, true);
