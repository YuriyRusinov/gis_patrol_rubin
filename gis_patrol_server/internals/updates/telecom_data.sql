...
--
select setval('tbl_communication_categories_id_seq', 199, true);
...
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (236, 10, null::integer, false, 'Системы кондиционирования', 'TELECOM_CATEGORY_236', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (237, 8, 236, true, 'Справочник систем кондиционирования', 'TELECOM_CATEGORY_237', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (238, 10, null::integer, false, 'Системы отопления', 'TELECOM_CATEGORY_238', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (239, 8, 238, true, 'Справочник систем отопления', 'TELECOM_CATEGORY_239', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (240, 10, null::integer, false, 'Системы вентиляции', 'TELECOM_CATEGORY_240', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (241, 8, 240, true, 'Справочник систем вентиляции', 'TELECOM_CATEGORY_241', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (242, 10, null::integer, false, 'Размещение оборудования по помещениям', 'TELECOM_CATEGORY_242', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (243, 8, 242, true, 'Справочник размещения оборудования', 'TELECOM_CATEGORY_243', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (244, 10, null::integer, false, 'Субмодули', 'TELECOM_CATEGORY_244', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (245, 8, 244, true, 'Справочник субмодулей', 'TELECOM_CATEGORY_245', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (246, 10, null::integer, false, 'Размещение субмодулей', 'TELECOM_CATEGORY_246', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (247, 8, 246, true, 'Справочник размещения субмодулей', 'TELECOM_CATEGORY_247', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (248, 10, null::integer, false, 'Колодцы ВОЛС', 'TELECOM_CATEGORY_248', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (249, 8, 248, true, 'Справочник колодцев ВОЛС', 'TELECOM_CATEGORY_249', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (250, 10, null::integer, false, 'Регенераторы ВОЛС', 'TELECOM_CATEGORY_250', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (251, 8, 250, true, 'Справочник регенераторов ВОЛС', 'TELECOM_CATEGORY_251', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (252, 10, null::integer, false, 'Линейная часть ВОЛС', 'TELECOM_CATEGORY_252', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (253, 8, 252, true, 'Справочник линейных частей ВОЛС', 'TELECOM_CATEGORY_253', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (254, 10, null::integer, false, 'Стационарная часть ВОЛС', 'TELECOM_CATEGORY_254', null::varchar, true) on conflict do nothing;
insert into tbl_communication_categories (id, id_category_type, id_child, is_main, name, code, description, is_system) values (255, 8, 254, true, 'Справочник стационарных частей частей ВОЛС', 'TELECOM_CATEGORY_255', null::varchar, true) on conflict do nothing;
select setval('tbl_communication_categories_id_seq', 300, true);
...
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (707, 236, 1, null, true, true, 1) on conflict do nothing; -- id
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (708, 236, 450, null, true, false, 2) on conflict do nothing; -- id_building
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (709, 236, 445, null, true, false, 3) on conflict do nothing; -- id_floor
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (710, 236, 500, null, false, false, 4) on conflict do nothing;

insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (711, 238, 1, null, true, true, 1) on conflict do nothing; -- id
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (712, 238, 450, null, true, false, 2) on conflict do nothing; -- id_building
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (713, 238, 445, null, true, false, 3) on conflict do nothing; -- id_floor
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (714, 238, 499, null, false, false, 4) on conflict do nothing;

insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (715, 240, 1, null, true, true, 1) on conflict do nothing; -- id
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (716, 240, 450, null, true, false, 2) on conflict do nothing; -- id_building
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (717, 240, 445, null, true, false, 3) on conflict do nothing; -- id_floor
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (718, 240, 501, null, false, false, 4) on conflict do nothing;

insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (719, 242, 1, null, true, true, 1) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (720, 242, 446, null, true, false, 2) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (721, 242, 490, null, true, false, 3) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (722, 242, 491, null, true, false, 4) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (723, 242, 492, null, false, false, 5) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (724, 242, 493, null, false, false, 6) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (725, 242, 494, null, false, false, 7) on conflict do nothing;

insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (726, 244, 1, null, true, true, 1) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (727, 244, 504, null, false, false, 2) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (728, 244, 505, null, false, false, 3) on conflict do nothing;

insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (729, 246, 1, null, true, true, 1) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (730, 246, 503, null, true, false, 2) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (731, 246, 506, null, false, false, 3) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (732, 246, 502, null, true, false, 4) on conflict do nothing;

insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (733, 248, 1, null, true, true, 1) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (734, 248, 482, null, true, false, 2) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (735, 248, 89, null, false, false, 3) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (736, 248, 88, null, false, false, 4) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (737, 248, 90, null, false, false, 5) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (737, 248, 100, '4326'::varchar, false, false, 6) on conflict do nothing;

insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (738, 250, 1, null, true, true, 1) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (739, 250, 483, null, true, false, 2) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (740, 250, 484, null, true, false, 3) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (741, 250, 89, null, false, false, 4) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (742, 250, 88, null, false, false, 5) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (743, 250, 100, '4326'::varchar, false, false, 6) on conflict do nothing;

insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (744, 252, 1, null, true, true, 1) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (745, 252, 475, null, true, false, 2) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (746, 252, 477, '0'::varchar, true, false, 3) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (747, 252, 478, null, false, false, 4) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (748, 252, 479, '0'::varchar, true, false, 5) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (749, 252, 480, null, true, false, 6) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (750, 252, 481, null, false, false, 7) on conflict do nothing;

insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (751, 254, 1, null, true, true, 1) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (752, 254, 466, null, true, false, 2) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (753, 254, 467, null, false, false, 3) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (754, 254, 468, null, false, false, 4) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (755, 254, 469, null, false, false, 5) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (756, 254, 470, null, true, false, 6) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (757, 254, 471, null, true, false, 7) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (758, 254, 472, null, false, false, 8) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (759, 254, 473, null, false, false, 9) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (760, 254, 474, null, false, false, 10) on conflict do nothing;
insert into tbl_cat_params(id, id_category, id_parameter, default_value, is_mandatory, is_read_only, param_sort_order) values (761, 254, 415, null, false, false, 11) on conflict do nothing;
select setval('tbl_cat_params_id_seq', 800, true);

--
-- Справочники
--
select setval('tbl_communication_objects_references_id_seq', 100, true);
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (101, 1, 201, 'Справочник типов объектов ИСС', null::varchar, 'tbl_iss_object_type', 'Типы объектов ИСС', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (102, 1, 201, 'Справочник типов узлов ИСС', null::varchar, 'tbl_iss_node_type', 'Типы узлов ИСС', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (103, 1, 201, 'Справочник типов строений', null::varchar, 'tbl_object_building_type', 'Типы строений', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (104, 1, 203, 'Справочник ИСС объектов', null::varchar, 'tbl_iss_objects', 'Объекты ИСС', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (105, 1, 205, 'Справочник смежных объектов', null::varchar, 'tbl_iss_object_adjacent_objects', 'Соседние объекты ИСС', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (106, 1, 207, 'Справочник узлов ИСС', null::varchar, 'tbl_iss_node', 'Узлы ИСС', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (107, 1, 209, 'Справочник сооружений', null::varchar, 'tbl_object_building', 'Сооружения ИСС', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (108, 1, 211, 'Справочник сертификатов', null::varchar, 'tbl_sertificates', 'Сертификаты ИСС', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (109, 1, 213, 'Аттестация узлов ИСС', null::varchar, 'tbl_node_sertificates', 'Сертификаты узлов ИСС', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (110, 1, 215, 'Справочники ПО', null::varchar, 'tbl_software', 'Справочники ПО', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (111, 1, 217, 'Справочники ПО на узлах ИСС', null::varchar, 'tbl_node_soft', 'Справочники ПО по узлам', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (112, 1, 219, 'Справочник политик безопасности', null::varchar, 'tbl_node_security', 'Атрибуты политик безопасности', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (113, 1, 221, 'Справочник помещений', null::varchar, 'tbl_rooms', 'Помещения', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (114, 1, 223, 'Справочник сигнализаций', null::varchar, 'tbl_fire_security_alarm', 'Пожарная или охранная сигнализация', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (115, 1, 225, 'Справочник состояний ТКО', null::varchar, 'tbl_state_tce', 'Состояния ТКО', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (116, 1, 227, 'Справочник ТКО', null::varchar, 'tbl_telecom_equipment', 'Телекоммуникационное оборудование', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (117, 1, 229, 'Справочник систем заземления', null::varchar, 'tbl_grounding_system', 'Система заземления', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (118, 1, 231, 'Справочник систем электропитания', null::varchar, 'tbl_electrical_systems', 'Системы электропитания', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (119, 1, 233, 'Справочник электрощитов', null::varchar, 'tbl_electrical_shield', 'Электрощиты', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (120, 1, 235, 'Справочник электротрансформаторов', null::varchar, 'tbl_electrical_transformator', 'Электротрансформаторы', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (121, 1, 237, 'Справочник систем кондиционирования', null::varchar, 'tbl_cond', 'Системы кондиционирования', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (122, 1, 239, 'Справочник систем отопления', null::varchar, 'tbl_heating', 'Системы отопления', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (123, 1, 241, 'Справочник систем вентиляции', null::varchar, 'tbl_venting', 'Системы вентиляции', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (124, 1, 243, 'Справочник размещения модулей по помещениям', null::varchar, 'tbl_equipment_distr', 'Размещение ТКО по помещениям', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (125, 1, 245, 'Справочник субмодулей', null::varchar, 'tbl_telecom_submodules', 'Субмодули', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (126, 1, 247, 'Справочник размещения субмодулей', null::varchar, 'tbl_submodules_distr', 'Размещение субмодулей', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (127, 1, 249, 'Справочник колодцев ВОЛС', null::varchar, 'tbl_well_shaft', 'Колодцы ВОЛС', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (128, 1, 251, 'Справочник регенераторов ВОЛС', null::varchar, 'tbl_regenerator', 'Регенераторы ВОЛС', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (129, 1, 253, 'Справочник линейных частей ВОЛС', null::varchar, 'tbl_linear_part_vols', 'Линейная часть ВОЛС', false, current_timestamp, true) on conflict do nothing;
insert into tbl_io_communication_objects_references (id, id_author, id_category, name, description, table_name, information, is_system, insert_time, is_global) values (130, 1, 255, 'Справочник стационарных частей ВОЛС', null::varchar, 'tbl_stationary_part_vols', 'Стационарная часть ВОЛС', false, current_timestamp, true) on conflict do nothing;
select setval('tbl_communication_objects_references_id_seq', 130, true);
--
