...
class GISPatrolPGResult : public GISPatrolResult
{
    public:
        GISPatrolPGResult(PGresult * _res);
        ~GISPatrolPGResult();

        GISPatrolResult::DataType getColumnDataType(int column) const ;
        ...
        static int toInternalType(GISPatrolResult::DataType type);
