...
class __DA_EXPORT GISPatrolDatabase : QObject
{
    ...
    public:
        ...
        virtual GISPatrolResult * execParams(
                                        const char* command, 
                                        int nParams, 
                ...
                GISPatrolResult * execParams(
                                        ...
                                        const QList<GISPatrolResult::DataType>& paramTypes, 
        ...
        virtual GISPatrolResult* declare(QString cursor_name, QString sql_string) const = 0;
        virtual GISPatrolResult* fetch(QString cursor_name, int direction, int count_str = 0) const = 0;
        virtual GISPatrolResult* move(QString cursor_name, int direction, int count_str = 0) const = 0;
        virtual GISPatrolResult* close(QString cursor_name) const = 0;
